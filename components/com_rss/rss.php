...
if(empty($task) || $task == '') {
	...
	$output .= "<title>Raid-Planner pour DragonWar</title>\n
				<description>Liste des Raids ".$pConfig['game']."</description>\n
	...
	$output = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n";
	$output .= "<rss version=\"2.0\">\n<channel>";
	$output .= "<title>Raid-Planner".$pLang['rssAnnouncementsFor']." ".$pConfig['game']."</title>\n
				<description>Raid-Planner ".$pLang['rssAnnouncementsFor']." ".$pConfig['game']."</description>\n
				<link>".$pConfig['site_url']."</link>\n
				<lastBuildDate>".date(DATE_RFC2822,gmmktime())."</lastBuildDate>\n
				<language>en-us</language>\n";
